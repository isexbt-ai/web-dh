...
<body>
        ...
        <main class="main-content">
            ...
            <div class="table-section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h2 class="section-title" style="margin-bottom: 0;">链接列表</h2>
                    <button class="btn btn-primary" onclick="openModal('linkModal')">添加链接</button>
                </div>

                <?php if (empty($links)): ?>
                <div class="empty-state">暂无链接，点击上方按钮添加</div>
                <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="toggle-switch">
                                    <input type="checkbox" <?php echo $link['is_active'] ? 'checked' : ''; ?> onchange="toggleStatus('link', <?php echo $link['id']; ?>, this.checked)">
    ...
    <div class="modal-overlay" id="linkModal">
        <div class="modal-content">
            ...
            <form id="linkForm" onsubmit="return saveLink(event)">
                <input type="hidden" id="linkId" name="id" value="0">
                <div class="form-group">
                    <label>链接标题</label>
                    <input type="text" id="linkTitle" name="title" placeholder="如：复制链接、分享页面" required>
                </div>
                <div class="form-group">
                    <label>链接地址</label>
                ...
                <div class="form-group">
                    <label>排序</label>
                    <input type="number" id="linkSort" name="sort_order" value="0" min="0">
                </div>
                <div class="form-group">
                    <label>
    ...
    <script>
        async function saveLink(e) {
            ...
            data.is_active = document.getElementById('linkActive').checked ? 1 : 0;
        ...
        function editLink(btn) {
            ...
            document.getElementById('linkSort').value = sortOrder;
            document.getElementById('linkActive').checked = isActive === 1;
