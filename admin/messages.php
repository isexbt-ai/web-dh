...
<body>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    ...
                                    <?php if (!empty($msg['reply'])): ?>
                                    <button class="btn btn-danger btn-sm" onclick="deleteReply(<?php echo $msg['id']; ?>)" style="padding: 6px 12px; font-size: 12px; background: rgba(244,67,54,0.1); border: 1px solid rgba(244,67,54,0.2); color: #f44336; border-radius: 8px; cursor: pointer; transition: all 0.3s;">删除回复</button>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
    ...
    <script>
        ...
        function deleteReply(id) {
            ...
            saveData('messageReply', { id: id, reply: '' }, () => location.reload());
        }
